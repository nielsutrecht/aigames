package com.nibado.project.aigames.texas.stevebrecher;

/**
 * Non-instantiable class containing a variety of static com.nibado.project.aigames.texas.poker hand evaluation and related utility methods.
 * <p>
...
public final class HandEval {
	...
	*/
	...
	/**
	 * Returns the value of the best 5-card high com.nibado.project.aigames.texas.poker hand from 7 cards.
	 * @param hand bit mask with one bit set for each of 7 cards.
	 * @return the value of the best 5-card high com.nibado.project.aigames.texas.poker hand.
	 */
	...
	/**
	 * Returns the value of the best 5-card Razz com.nibado.project.aigames.texas.poker hand from 7 cards.
	 * @param hand bit mask with one bit set for each of 7 cards.
	 * @return the value of the best 5-card Razz com.nibado.project.aigames.texas.poker hand.
	 */
	...
	/**
	 * Returns the value of the best 5-card high com.nibado.project.aigames.texas.poker hand from 6 cards.
	...
	/**
	 * Returns the value of a 5-card com.nibado.project.aigames.texas.poker hand.
	...
	/**
	 * Returns the Deuce-to-Seven low (Kansas City lowball) value of a 5-card com.nibado.project.aigames.texas.poker hand.
	 * @param hand bit mask with one bit set for each of 5 cards.
	 * @return the value of the hand.
	 */
	...
	/**
	 * Returns the Ace-to-5 value of a 5-card low com.nibado.project.aigames.texas.poker hand.
	 * @param hand bit mask with one bit set for each of 5 cards.
	...
	/**
	 * Returns the 8-or-better low value of a 5-card com.nibado.project.aigames.texas.poker hand or {@link #NO_8_LOW}.
	...
	/**
	 * Returns the 8-or-better low value of a 5-card com.nibado.project.aigames.texas.poker hand comprised of three board
