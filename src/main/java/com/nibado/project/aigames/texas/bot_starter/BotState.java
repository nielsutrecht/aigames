...
public class BotState {
	...
	protected void updateSetting(String key, String value) {
		...
		if( key.equals("your_bot") ) {
			myName = value;
		} else if ( key.equals("timebank") ) {			// Maximum amount of time your com.nibado.project.aigames.texas.bot_starter can take for one response
		...
		} else if ( key.equals("starting_stack") ) {	// Starting stack for each com.nibado.project.aigames.texas.bot_starter
	...
	protected void updateMatch(String key, String value) {
		...
		} else if( key.equals("on_button") ) {		// Which com.nibado.project.aigames.texas.bot_starter has the button, onButton is true if it's your com.nibado.project.aigames.texas.bot_starter
	 ...
	 * @param bot : com.nibado.project.aigames.texas.bot_starter that this move belongs to (either you or the opponent)
	 * @param key : key of the information given
